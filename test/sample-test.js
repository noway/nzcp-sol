...
describe("NZCP - test pass URIs", function () {
  ...
  it("Should fail on BAD_PUBLIC_KEY_PASS_URI", async function () {
    ...
    expect(nzcp.readCredSubj(pass.ToBeSigned, [pass.r, pass.s], 1)).to.be.revertedWith("InvalidSignature()")
  });
  ...
  it("Should fail on EXPIRED_PASS_URI", async function () {
    ...
    expect(nzcp.readCredSubj(pass.ToBeSigned, [pass.r, pass.s], 1)).to.be.revertedWith("PassExpired()")
  });
